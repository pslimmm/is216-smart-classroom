    ...
    <div class="overlay">
        <div class="modal-wrapper bg-white rounded-5 p-4 m-3">
            <div class="d-flex flex-row justify-content-between align-items-center">
                <h3 class="text-navy fs-1">Approve Class Participation</h3>
            ...
            <label for="coins-awarded" class="mt-3 fs-2 fw-semibold">Coins Awarded</label>
            <input type="number" class="form-control fs-4" v-model="coins_awarded">
            ...
            <button type="submit" class="btn btn-success w-100 fs-3 mt-4 fw-semibold" @click="handleSubmit()">
                Approve
            </button>
        </div>
    </div>
