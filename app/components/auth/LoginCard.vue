...
<template>
    ...
    <p class="text-center text-muted fs-5">Login to your account</p>
    <form @submit.prevent="handleSubmit">
        <!-- email -->
        <div class="mb-2">
            <label for="loginEmail" class="form-label fw-semibold fs-5">Email</label>
            <input v-model="formData.email" type="email" class="form-control fs-5" id="loginEmail"
                placeholder="you@example.com" required />
        </div>
        <!-- password -->
        <div class="mb-2">
            <label for="loginPassword" class="form-label fw-semibold fs-5">Password</label>
