...
<template>
    ...
    <main class="container py-4 flex-grow-1">
        <div class="container py-4">
            <div class="mb-4">
                <h2 class="display-1 fw-bold">Welcome back, Teaching Assistant!</h2>
                <p class="fs-2 text-muted">Record and track student participations</p>
            </div>
        </div>
        ...
        <div class="row g-4 mb-4">
            <div class="col-md-4">
                <div class="card shadow-sm">
                    <div class="card-body d-flex justify-content-between align-items-center pb-2">
                        ...
                        <i class="fs-1 bi bi-people-fill text-primary"></i>
                    </div>
            ...
            <div class="col-md-4">
                <div class="card shadow-sm">
                    <div class="card-body d-flex justify-content-between align-items-center pb-2">
                        <h6 class="fs-2 mb-0 text-muted">Today's Participations</h6>
                        <i class="fs-1 bi bi-graph-up text-success"></i>
                    </div>
                    <div class="card-body pt-0">
                        <div class="fs-3 fw-bold">{{ stats.todayParticipations }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card shadow-sm">
                    <div class="card-body d-flex justify-content-between align-items-center pb-2">
                        <h6 class="fs-2 mb-0 text-muted">Total Recorded</h6>
                        <i class="fs-1 bi bi-check-circle text-info"></i>
                    </div>
                    <div class="card-body pt-0">
                        <div class="fs-3 fw-bold">{{ stats.totalParticipations }}</div>
                    </div>
                </div>
            </div>
        </div>
